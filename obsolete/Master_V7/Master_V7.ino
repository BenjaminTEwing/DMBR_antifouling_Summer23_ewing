...
// DateTime now = rtc.now();
  ...
  * 
  */
#define MPX_PlusVout_pin A0// output pin for pressure transducer
#define MPX_MinusVout_pin A1 // output pin for pressure transducer
...
const int forward1 = 34; //For encoder/motor and Connected to H bridge (controls motor direction)
const int forward2 = 36; //For encoder/motor and Connected to H bridge (controls motor direction)
const int reverse1 = 38; //For encoder/motor and Connected to H bridge (controls motor direction)
const int reverse2 = 40; //For encoder/motor and Connected to H bridge (controls motor direction)
