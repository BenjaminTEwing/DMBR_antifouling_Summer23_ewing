...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
const int Take_data_interval = 30000; //30000 = 30 sec interval at which data will be collected from any operable sysytem sensor

const int non_repeat_const = 200; //value of milliseconds meant to prevent accidental double writes of data
const long wipe_interval = 60;  // 30 sec * 60 = 30 min How many data logs between wipes 
...
Serial.println("Calibrating Wiper");
wipe_forward();
